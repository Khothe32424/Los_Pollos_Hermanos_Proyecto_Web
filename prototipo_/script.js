...
const menuData = {
    Pollos: [
        {name:'Pollo entero a la brasa', description:'Pollo entero con papas fritas, ensalada y cremas.', price:58, image:'img_menu/menu_pollo_entero.png'},
        {name:'1/2 Pollo a la brasa', description:'Medio pollo con papas fritas, ensalada y cremas.', price:32, image:'img_menu/menu_medio_pollo.png'},
        {name:'1/4 Pollo a la brasa', description:'Cuarto de pollo con papas fritas, ensalada y cremas.', price:20, image:'img_menu/menu_cuarto_pollo.png'},
        {name:'Combo familiar', description:'Pollo entero, papas familiares, ensalada y gaseosa 1.5 L.', price:75, image:'img_menu/menu_combo_familiar.png'},
        {name:'Combo pareja', description:'1/2 pollo, papas y 2 bebidas personales.', price:42, image:'img_menu/menu_combo_pareja.png'}
    ],
    Parrillas: [
