...
function registrar(){
 ...
 localStorage.setItem('usuario',JSON.stringify({nombre,correo,tel,dir,pass,apodo:'',direcciones:dir}));
...
function ingresar(){
 ...
 const pass=document.getElementById('password').value;
 const u=getUser();
 if(u && u.correo===correo && u.pass===pass){alert('Bienvenido '+u.nombre);location.href='cuenta.html';}
